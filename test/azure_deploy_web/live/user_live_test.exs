defmodule AzureDeployWeb.UserLiveTest do
  use AzureDeployWeb.ConnCase

  import Phoenix.LiveViewTest
  import AzureDeploy.AccountsFixtures

  @create_attrs %{age: 42, email: "some email", firstname: "some firstname", lastname: "some lastname", password: "some password"}
